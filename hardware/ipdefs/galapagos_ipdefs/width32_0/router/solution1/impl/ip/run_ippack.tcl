...
set Library     "hls"
set IPName      "width32router"
set Version     "1.0"
set DisplayName "Width32router"
set Revision    "2108240806"
...
set sdx_kernel_name "router"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/gaoyu/ECE2500Y/galapagos/hlsBuild/sidewinder/ip/width32/router/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {router
}
set kernel_xo ""

## Variables
set Top "width32router"
set TopNoPrefix "router"
...
set Interfaces {
    ap_clk {
        ...
        buses "stream_in stream_out_switch stream_out_network"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    stream_out_network {
        type "axi4stream"
        mode "master"
        port_prefix "stream_out_network"
        has_tready "1"
        ports {
            TDATA 512
            TKEEP 64
...
## System Info
set user_parameters_list {clk_period 3.103 machine 64 combinational 0 latency 3 II 2}
