...
// ==============================================================
#ifndef __kern_enc_SBOX_V_H__
#define __kern_enc_SBOX_V_H__
...
struct kern_enc_SBOX_V_ram : public sc_core::sc_module {
...
kern_enc_SBOX_V_ram* meminst;


SC_CTOR(kern_enc_SBOX_V) {
meminst = new kern_enc_SBOX_V_ram("kern_enc_SBOX_V_ram");
