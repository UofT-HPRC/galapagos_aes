...
// ==============================================================
#ifndef __kern_dec_INV_SBOX_V_H__
#define __kern_dec_INV_SBOX_V_H__
...
struct kern_dec_INV_SBOX_V_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(kern_dec_INV_SBOX_V_ram) {
        ram[0] = "0b01010010";
        ram[1] = "0b00001001";
        ram[2] = "0b01101010";
        ram[3] = "0b11010101";
...
kern_dec_INV_SBOX_V_ram* meminst;


SC_CTOR(kern_dec_INV_SBOX_V) {
meminst = new kern_dec_INV_SBOX_V_ram("kern_dec_INV_SBOX_V_ram");
