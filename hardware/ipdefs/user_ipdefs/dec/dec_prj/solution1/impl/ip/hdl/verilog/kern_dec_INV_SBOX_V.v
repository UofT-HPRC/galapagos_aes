...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module kern_dec_INV_SBOX_V_rom (
...
initial begin
    $readmemh("./kern_dec_INV_SBOX_V_rom.dat", ram0);
    $readmemh("./kern_dec_INV_SBOX_V_rom.dat", ram1);
    $readmemh("./kern_dec_INV_SBOX_V_rom.dat", ram2);
    $readmemh("./kern_dec_INV_SBOX_V_rom.dat", ram3);
    $readmemh("./kern_dec_INV_SBOX_V_rom.dat", ram4);
    $readmemh("./kern_dec_INV_SBOX_V_rom.dat", ram5);
    $readmemh("./kern_dec_INV_SBOX_V_rom.dat", ram6);
    $readmemh("./kern_dec_INV_SBOX_V_rom.dat", ram7);
end
...
kern_dec_INV_SBOX_V_rom kern_dec_INV_SBOX_V_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
