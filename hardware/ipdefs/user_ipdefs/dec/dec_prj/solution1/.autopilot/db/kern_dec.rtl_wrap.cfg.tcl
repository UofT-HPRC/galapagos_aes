...
set DataType1ta0 "[list ap_uint 512 ]"
set structArgument1 [list $DataType1ta0 ]
set SpaceName10 "galapagos"
set NameSpace1 [list  [list  space $SpaceName10] ]
set structIsPacked1 "0"
set DataType1 [list "galapagos::stream_packet<ap_uint<512> >" "struct stream_packet" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
...
set DataType25 "[list ap_uint 64 ]"
...
set structParameter2 [list [list typename T] ]
set DataType2ta0 "[list ap_uint 512 ]"
set structArgument2 [list $DataType2ta0 ]
set SpaceName20 "galapagos"
set NameSpace2 [list  [list  space $SpaceName20] ]
set structIsPacked2 "0"
set DataType2 [list "galapagos::stream_packet<ap_uint<512> >" "struct stream_packet" $structMem2 1 0 $structParameter2 $structArgument2 $NameSpace2 $structIsPacked2]
